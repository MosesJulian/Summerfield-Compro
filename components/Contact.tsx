...
const Contact: FC<ContactProps> = ({ className }: ContactProps) => {
	return (
		<div
			className={clsx('flex flex-col gap-8 px-10 md:px-20 lg:px-56', className)}
			id="contact"
		>
			<div className="text-2xl font-bold text-center">Contact Us</div>
			<div className="grid grid-cols-2 gap-8">
				<div className="col-span-2 md:col-span-1 md:grid flex flex-col justify-around items-center gap-8">
					<div className="flex gap-2 items-center">
						<AiOutlineInstagram size={40} className="text-pink-600" />
						<span className="md:text-xl font-semibold">@summerfieldbeach</span>
					</div>

					<div className="flex gap-2 items-center">
						<AiOutlineWhatsApp size={40} className="text-green-800" />
						<span className="md:text-xl font-semibold">+62 852-1166-2279</span>
					</div>
